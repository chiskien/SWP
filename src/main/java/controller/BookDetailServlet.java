 ...
 * @author hoang
 */
@WebServlet(urlPatterns = {"/BookDetailServlet"})
public class BookDetailServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
            ...
            List<Category> listCate = new CategoryDao().getAllWithBookId(id);
            ...
            boolean isFollow = FollowDao.getFollowOrNot(id, accountId);
            ...
            int mark = new BookDao().getRate(id);
            request.setAttribute("rateMark", mark);
            request.setAttribute("translator", translator);
            request.setAttribute("lsChapter", lsChapter);
