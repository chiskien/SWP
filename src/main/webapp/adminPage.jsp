                ...
                <form action="NotificationSender">
                    <div class="hmodal-body">
                        ...
                        <select name="account">
                            ...
                            <% for (Account a : accs) {%>
                            <option value=<%= a.getAccountId()%>><%= a.getName()%>
                            </option>
                            <%}%>
                        </select>
                        ...
                        <select name="translator">
                            ...
                            <option value=<%= t.getTranslatorId()%>><%= t.getName()%>
                            </option>
                            <%}%>
                        </select>
...
//                        List<Account> list = (List<Account>) request.getAttribute("RequestList");
    ...
    %>
        <table class="table table-striped table-hover">
            ...
            <tr>
                <th scope="row"
                    onclick="myFunction('<%=list.get(i).getAccountId()%>', '<%=list.get(i).getName()%>', '<%=list.get(i).getEmail()%>', '<%=list.get(i).getRole()%>', '<%=list.get(i).getStatus()%>')">
                ...
                <td>
                    ...
                    <a href="DeleteServlet/Account?id=<%=list.get(i).getAccountId()%>"
            ...
            <div id="myModal2" class="hmodal" style="text-align: left;">
                ...
                <div class="hmodal-content">
                    ...
                    <form action="EditServlet/Account">
                        ...
                        <div class="hmodal-footer">
                            <button class="btn btn-outline-light" type="submit" id="savebtn" style="margin: 15px">Save
                            </button>
                        </div>
                    </form>
                </div>
    ...
    %>
        <table class="table table-striped table-hover">
            ...
            <tr>
                <th scope="row"
                    onclick="myFunction('<%=list.get(i).getReportId()%>', '<%=list.get(i).getAccountId()%>', '<%=list.get(i).getBookId()%>', '<%=list.get(i).getCommentId()%>', '<%=list.get(i).getContent()%>', '<%=list.get(i).getStatus()%>')">
                ...
                <td>
                    <a href="ServletReportDetail?aid=<%=list.get(i).getReportId()%>">
                        <button type="button" id="" class="btn btn-info" data-toggle="tooltip" data-placement="top"
                                title="Pass">
                            <i class="fas fa-check"></i>
                        </button>
                    </a>
                    <a href="SystemPunisherServlet?aid=<%=list.get(i).getReportId()%>">
                        <button type="button" id="" class="btn btn-danger" data-toggle="tooltip" data-placement="top"
                                title="Ban">
    ...
    %>
        <table class="table table-striped table-hover">
            ...
            <tr>
                <th scope="row"
                    onclick="myFunction('<%=list.get(i).getId()%>', '<%=list.get(i).getName()%>', '<%=list.get(i).getAuthorId()%>', '<%=list.get(i).getTranslatorId()%>', '<%=list.get(i).getTotalChap()%>', '<%=list.get(i).getAppear()%>', '<%=list.get(i).getTotalView()%>', '<%=list.get(i).getStatus()%>', '<%=list.get(i).getDescription()%>', '<%=list.get(i).getImgName()%>')">
                        <%=list.get(i).getId()%>
                </td>
                ...
                <td>
                    ...
                    <a href="DeleteServlet/Book?id=<%=list.get(i).getId()%>"
                ...
                <div class="hmodal-content">
                    ...
                    <form action="EditServlet/Book">
                        <div class="hmodal-body">
                            ...
                            <p style="display: block;"></p>
                            <p style="display: inline;">Description: </p><textarea id="i2" name="description"
    ...
    %>
        <table class="table table-striped table-hover">
            ...
            <tr>
                <th scope="row"
                    onclick="myFunction('<%=list.get(i).getTranslatorId()%>', '<%=list.get(i).getName()%>', '<%=list.get(i).getLinkFanpage()%>', '<%=list.get(i).getDonationAccount()%>', '<%=list.get(i).getImgName()%>', '<%=list.get(i).isStatus()%>')">
                        <%=list.get(i).getTranslatorId()%>
                </td>
                ...
                <td>
                    ...
                    <a href="DeleteServlet/Translator?id=<%=list.get(i).getTranslatorId()%>"
                       onclick="return confirm('Are you sure you want to delete this Translator?');">Delete</a>
                </td>
            </tr>
            <div id="myModal" class="hmodal" style="text-align: left;">
                <!-- Modal content -->
