                  ...
                  <c:forEach items="${requestScope.data}" var="book">
                    <div class="card2">
                      ...
                      <div class="profile">
                        ...
                        />
                        <div class="delete">
                            <a href="UserDeleteBookmarkServlet?bookId=${book.id}&accountId=${sessionScope.accountId}" style="color: aliceblue"
                        ...
                        <div class="bottom">
                          <div class="book-name">
                            ...
                            <a href="ChapterDetailServlet?bookId=${book.id}&chapterId=${book.bookmarkedChapterId}&chapterName=${book.bookmarkedChapter}">
                            <button class="book-action2 b3">
                            Continue at ${book.bookmarkedChapter}
                          </button>
                            </a>
