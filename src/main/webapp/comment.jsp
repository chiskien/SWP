...
<input style="display:none" id="temp"
...
<div class="comment-section container">
    <div class="row">
        ...
        <c:forEach items="${requestScope.lsComment}" var="comment">
            ...
            <div class="col-md-12">
                <button type="button" class="btn btn-danger dropdown-toggle delete2" data-toggle="dropdown"
                ...
                <div class="dropdown-menu book-report">
                    ...
                    <div class="dropdown-item">
                        <a href="ReportServlet?id=${requestScope.book.id}&accountId=${sessionScope.accountId}&content=AbusiveContent&commentId=${comment.commentId}&status=1&type=comment">
                            Abusive content
                        </a>
                    </div>
                    ...
                    <div class="dropdown-item">
                        <a href="ReportServlet?id=${requestScope.book.id}&accountId=${sessionScope.accountId}&content=HateSpeech&commentId=${comment.commentId}&status=1&type=comment">
                            Hate speech
                        </a>
                    </div>
