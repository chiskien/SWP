                        ...
                        <div class="bookDetail-information">
                            ...
                            <div class="action">
                                <div class="action-1">
                                    ...
                                    <button type="button" class="action-follow" style="margin-left: 15px" onclick="setClipboard()"  data-toggle="popover" data-placement="top" data-content="Copied Comic's Link">
